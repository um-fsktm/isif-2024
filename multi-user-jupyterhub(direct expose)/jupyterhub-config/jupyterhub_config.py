...
# Set the spawner to DockerSpawner
c.JupyterHub.spawner_class = 'dockerspawner.DockerSpawner'

# Set the Docker image for user containers
c.DockerSpawner.image = 'jupyter/base-notebook:latest'

# Mount the user's home directory
c.DockerSpawner.volumes = {'jupyterhub-user-{username}': '/home/tein/jupyterhub'}
...
# Use NativeAuthenticator for token-based authentication
...
c.Authenticator.allowed_users = {'user1', 'user2'}  # Allow specific users
c.Authenticator.admin_users = {'admin'}  # Define admin users

# Optionally, set passwords for users
c.Authenticator.password_required = True
c.Authenticator.create_system_users = True  # Create system users if they don't exist

# Example: Predefine user passwords (optional)
c.Authenticator.pre_spawn_start = {
